    ...
    <div className='min-h-[calc(100vh_-_433px)]'>
        <div className='flex justify-between items-center md:flex-row flex-col'>
            ...
            <table className="w-full text-sm text-center text-gray-500 min-w-[1000px]">
             ...
             {cart.products.map((product)=> (
                 <tr className=" bg-secondary border-gray-700
                  hover:bg-primary transition-all" key={product.id}> 
               ...
               <td className="py-4 px-6 whitespace-nowrap hover:text-white">${product.price}</td>
               <td className="py-4 px-6 whitespace-nowrap hover:text-white">{product.quantity}</td>
              </tr>  )
             )}
                </tbody>
            </table>
            ...
            <div className='bg-secondary min-h-[calc(100vh_-_433px)]
             flex flex-col justify-center text-white p-12 md:w-auto
