        ...
        <div className="flex md:justify-between justify-center text-center flex-wrap md:gap-y-0 gap-y-6 ">
          ...
          <div className="md:flex-1">
            ...
            <div className="flex items-center justify-center mt-5 gap-x-2">
              ...
              >
                <i className="fa fa-facebook hover:text-primary transition-all"></i>
              </a>
              <a
                href=""
                className="w-8 h-8 grid place-content-center bg-white text-secondary rounded-full"
              >
                <i className="fa fa-twitter hover:text-primary transition-all"></i>
              </a>
              <a
                href=""
                className="w-8 h-8 grid place-content-center bg-white text-secondary rounded-full"
              >
                <i className="fa fa-linkedin hover:text-primary transition-all"></i>
              </a>
              <a
                href=""
                className="w-8 h-8 grid place-content-center bg-white text-secondary rounded-full"
              >
                <i className="fa fa-instagram hover:text-primary transition-all"></i>
              </a>
              <a
                href=""
                className="w-8 h-8 grid place-content-center bg-white text-secondary rounded-full"
              >
                <i className="fa fa-pinterest hover:text-primary transition-all"></i>
              </a>
            </div>
          </div>
          <div className="md:flex-1">
